...
public class TeacherController {
    ...
    public TeacherController(IExpCourseService expCourseService, 
    ...
    public ModelAndView toListPage() {
        return UserUtil.getMv("/teacher/listMyExpCourse");
    }
    ...
    public ModelAndView handleCourseTask(){
        return UserUtil.getMv("teacher/listStudentCourseTask");
    }
    /**
     * 实验课程按条件分页查询
     * @param pageNum
    ...
    public JsonResult uploadTeachMaterials( MultipartFile multipartFile, Integer expCourseId){
        try{
            ...
            log.error("教师上传实验讲义失败。原因：【{}】，上传人：【{}】，文件名【{}】",e.getMessage(), UserUtil.getCurrentLoginInfo().getUserName(), multipartFile.getOriginalFilename(), e);
            return JsonResult.error(e.getMessage());
        }
    }
