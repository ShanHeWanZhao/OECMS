...
CREATE TABLE `exp_course`  (
  ...
  `exp_course_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '该实验课的创建时间',
...
CREATE TABLE `formal_course`  (
  ...
  `formal_course_create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '正式课的创建时间',
...
CREATE TABLE `course_task`  (
  ...
  `course_task_create_time` timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
